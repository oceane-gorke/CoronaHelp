...
urlpatterns = [
    ...
    path('menuvisuel/', views.menuvisuel,name='menuvisuel'),
    path('menuvisuel/cartefoyer/', views.cartefoyer,name='cartefoyer'),
    path('menuvisuel/cartefrequence/', views.cartefrequence,name='cartefrequence'),
    path('menuvisuel/produits/', views.produits,name='produits'),
    path('menuvisuel/regimes/', views.regimes,name='regimes'),
